...
def gemini_bot(user_calorie_needs, relevent_food_combo, gemini=GeminiInitializer()):
    ...
    # Example usage E:\SenzMate\Diet-Plan\Diet-Plan Main\Notebooks\output_file.jsonl
    jsonl_file_path = 'E:\\SenzMate\\Diet-Plan\\Diet-Plan Main\\Notebooks\\output_file.jsonl'
