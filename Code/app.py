...
from KG_retrever import KG_data_retiver, csv_data_retrever, run_query
...
if 'user_dieses' not in st.session_state:
    st.session_state.user_dieses = ""
...
if selected == "Home":
    ...
    with general_detail_container:
        ...
        with col2:
            ...
            st.session_state.user_dieses = st.selectbox("Disease", ("Diabetes","Cholesterol","Thyroid"))
            st.session_state.user_goal = st.selectbox("Diet-Goal", ("Weight Gain", "Weight Loss"))
    ...
    with medical_detail_container:
        ...
        with col2:
            ...
            st.session_state.tc_hdl = st.number_input("Total Cholesterol/HDL Ratio (Tc/Hdl)", value=st.session_state.tc_hdl, help="Enter your Total Cholesterol/HDL Ratio (Tc/Hdl)")
            st.session_state.bp_dias = st.number_input("Bp Dias", value=st.session_state.bp_dias, help="Enter your bp dias")
    ...
    with generated_plan:
        ...
        if button:
            kg_data = csv_data_retrever(st.session_state.food_type, 
                                        st.session_state.user_dieses, 
